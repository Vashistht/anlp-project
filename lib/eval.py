...
def eval_ppl(model, trainloader, testloader, device=torch.device("cuda:0"), 
			 dataset="wikitext2", bsz=1):
...
# Function to evaluate perplexity (ppl) on a specified model and tokenizer
def eval_ppl_trainonly(model, trainloader, bsz=1, device=torch.device("cuda:0"), dataset="wikitext2"):
